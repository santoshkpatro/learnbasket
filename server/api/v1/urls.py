...
from server.api.v1.auth.views import LoginView, PasswordResetView, EmailVerifyView, RegisterView, ProfileDetailView, StatusView, GoogleCallbackView
from server.api.v1.programs.views import ProgramListView, ProgramDetailView, ProgramEnrolledView, LessonListView
from server.api.v1.orders.views import OrderCreateView, OrderProcessView, payment_view, OrderListView
